...
*/
      ...
      //info.update(layer.feature.properties.availability);
			...
			countryInfo.insertAdjacentHTML("afterbegin","'><h1>"+provinceName);
...
/*
var worldmap = document.getElementById("map-holder");provinceInfo = document.getElementById("provinceInfo");
allProvinces = worldmap.querySelectorAll();
